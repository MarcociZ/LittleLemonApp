        ...
        >
            ...
            >
                ...
                <HStack m='2' justifyContent='space-between'>
                    <Text as='h1' fontFamily='karla' textStyle='card'>{title}</Text>
                    <Text as='h2' fontFamily='karla' textStyle='card' color='#FB0707'>{price}</Text>
                </HStack>
                <Text m='2' as='p' fontFamily='karla' textStyle='card2' text-align='justify'>{description} </Text>
